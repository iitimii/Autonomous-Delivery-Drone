...
public:
    ...
    inline float getAx() const { return ax / 4096.0; } // m/s^2
    inline float getAy() const { return ay / 4096.0; }
    inline float getAz() const { return az / 4096.0; }
