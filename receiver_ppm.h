...
void set_esc_pwm(){
    OutTim->setCaptureCompare(1, channel_3, MICROSEC_COMPARE_FORMAT);
    OutTim->setCaptureCompare(2, channel_3, MICROSEC_COMPARE_FORMAT);
    OutTim->setCaptureCompare(3, channel_3, MICROSEC_COMPARE_FORMAT);
    OutTim->setCaptureCompare(4, channel_3, MICROSEC_COMPARE_FORMAT);
